...
url.root <- "C:/Rprojects/itineris/www/"
...
lexicon <- openxlsx::read.xlsx('C:/Users/supernova/Dropbox/My PC (supernova-pc)/Documents/itineris_gl/data/lexicon.xlsx')
...
```{r pactols, fig.height= 14, fig.width= 14, echo=TRUE, warning = F, fig.align='center', fig.cap=""}
library(rdflib)
