...
```{=html}
<iframe width="1200" height="700" src="https://anr-itineris.github.io/itineris/org/organisation"></iframe>
```
...
```{=html}
<iframe width="1200" height="700" src="https://www.bibracte.fr/bibracte-numerique"></iframe>
```
...
## Data Analysis <img src='https://raw.githubusercontent.com/zoometh/itineRis/main/results/logo.png' style='height: 45px;vertical-align: middle;'>
...
::: {.notes}
Bibracte has shown that the ISO 25964 standard for the management of thesauri is sufficiently flexible to describe the different "points of view" presiding over the elaboration of the specialised and evolving "micro-languages" of archaeologists
:::
...
# Case study: <br>the *fibula* 20475.01 MAN {background-color="#f3e7b3"}
...
<img src='https://raw.githubusercontent.com/anr-itineris/itineris/master/www/img/20475.01 MAN.png'>
