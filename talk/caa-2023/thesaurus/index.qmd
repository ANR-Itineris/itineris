...
>>>>>>> 86f99ec1bdddc2f725476df2ba5cd238944ba4de
...
WP3 takes care of open-source data and tools to provide to the scientific community open access results, codes and data produced during the project as well as after their publication.
:::
...
### Data <small>Analysis</small> <img src="https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-leaflet.png" style="height: 40px; vertical-align:middle">
...
### Data <small>Analysis</small> <img src="https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-plotly.png" style="height: 45px; vertical-align:middle">
...
# Case study: <small><br>the *sanguisuga fibula* 20475.01 MAN</small> {background-color="#f3e7b3"}
...
```{r}
lia <- read.csv2("https://raw.githubusercontent.com/ANR-Itineris/itineris/main/data/lia_results_sample.tsv", sep = "\t")
kable(lia) %>%
